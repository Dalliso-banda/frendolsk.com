/**
 * DevHolm Configuration — Frendo LSK
 * ====================================
 *
 * This is the site configuration file. The framework reads from it to wire
 * your theme, content, extensions, and feature flags to the engine.
 *
 * This file is never overwritten by upstream DevHolm updates.
 *
 * ─────────────────────────────────────────────────────────────────
 *  GETTING STARTED
 * ─────────────────────────────────────────────────────────────────
